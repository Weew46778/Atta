...
class MainActivity : AppCompatActivity() {
    ...
    private fun buildHome(): View {
        ...
        root.addView(Ui.text(
            this,
            "\nوضعیت واقعی: پنل اورلای، دستیار صوتی آفلاین، سلامت دستگاه و تست سیستم فعال است.\nسرور واقعی Minecraft فقط میتواند روی VPS/Linux اجرا شود؛ مسیر «روی گوشی» در این اپ قابل انجام نیست.",
            12f,
            0xFF9FB2C2.toInt()
        ))
