...
def main():
    ...
    gran = grade(ph("volc"), sat=0.75, bright=0.28, mult=(1.25, 0.95, 0.85),
                 contrast=0.95)
    ...
    bedrock = grade(slate, sat=0.3, bright=-0.12, contrast=1.08,
                    mult=(0.9, 0.92, 1.0))
    ...
    coarse, _cm = blend_noise(dirt, ph("gravel"), 145, amt=0.34, softness=0.09)
    ...
    path, _pm = blend_noise(grade(dirt, bright=0.06, sat=0.7, mult=(1.08, 1.0, 0.86)),
                            ph("gravel"), 146, amt=0.16, softness=0.08)
    ...
    rsand = grade(ph("sand2"), sat=0.55, mult=(1.22, 0.85, 0.62), warmth=0.03,
                  bright=-0.01)
    ...
    nbrick = grade(ph("brick3"), sat=0.5, bright=-0.18, mult=(0.8, 0.45, 0.5),
                   contrast=1.06)
