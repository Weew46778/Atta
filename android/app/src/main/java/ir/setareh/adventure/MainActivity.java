    ...
    @Override public void onCreate(Bundle saved) {
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            @Override public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                ...
                String mime = path.endsWith(".html") ? "text/html" : path.endsWith(".js") ? "application/javascript" : path.endsWith(".css") ? "text/css" : path.endsWith(".svg") ? "image/svg+xml" : path.endsWith(".png") ? "image/png" : path.endsWith(".woff2") ? "font/woff2" : path.endsWith(".webmanifest") ? "application/manifest+json" : "text/plain";
                try {
